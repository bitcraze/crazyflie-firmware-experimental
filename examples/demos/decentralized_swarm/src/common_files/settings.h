...
#define REACHED_WP_TIMEOUT        10000 //ms
...
#define LANDING_DURATION 5.0f //sec
...
// BOUNDS DEFINITIONS
#define MIN_X_BOUND -1.36f
#define MAX_X_BOUND 1.72f

#define MIN_Y_BOUND -1.66f
#define MAX_Y_BOUND 1.35f
