...
class TrafficController:
    ...
    STATE_GOING_TO_SPIRAL_FIRST_POINT=6
    STATE_WAITING_TO_START_TRAJECTORY = 7
    STATE_RUNNING_TRAJECTORY = 8
    STATE_GOING_TO_PAD = 9
    STATE_WAITING_AT_PAD = 10
    STATE_LANDING = 11
    STATE_CHECK_CHARGING = 12
    STATE_REPOSITION_ON_PAD = 13
    STATE_CRASHED = 14
