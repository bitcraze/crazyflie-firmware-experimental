...
umin = [-1.0] * (nu*N*N_MAV) # [umin0_t0, umin0_t1, ..., umin0_tN, umin1_t0, ..., umin1_tN ,..., uminN_t0, ..., uminN_tN]
umax = [+1.0] * (nu*N*N_MAV) # [umax0_t0, umax0_t1, ..., umax0_tN, umax1_t0, ..., umax1_tN ,..., umaxN_t0, ..., umaxN_tN]
