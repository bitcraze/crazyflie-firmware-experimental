...
struct posPidParams_s {
  float xKp; float xKi; float xKd; float xKff;
...
static struct posPidParams_s previousPosPidParams = {
  .xKp = PID_POS_X_KP, .xKi = PID_POS_X_KI, .xKd = PID_POS_X_KD, .xKff = PID_POS_X_KFF,
  .yKp = PID_POS_Y_KP, .yKi = PID_POS_Y_KI, .yKd = PID_POS_Y_KD, .yKff = PID_POS_Y_KFF,
  .zKp = PID_POS_Z_KP, .zKi = PID_POS_Z_KI, .zKd = PID_POS_Z_KD, .zKff = PID_POS_Z_KFF,
};
...
void resetPosPIDParamsToPrevious(void)
{
